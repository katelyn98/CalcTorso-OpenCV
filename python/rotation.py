...
def process():
    ...
    while(1):
        ...
        lowerPink = np.array([lowPink, 50, 100])
        upperPink = np.array([highPink, 255, 255])
        
        #This is actually Green
        lowerGreen = np.array([lowGreen, 50, 100])
        upperGreen = np.array([highGreen, 255, 255])
        ...
        __, thresh = cv.threshold(maskPink, 140, 255, cv.THRESH_BINARY)
        ...
        cv.putText(frame, "o", (55,75), font, 1, (255,255,255), 2, cv.LINE_AA)
        
        cv.putText(frame, str(round(angleCalculated)), (25,100), font, 1, (255, 255, 255), 2, cv.LINE_AA)
        cv.putText(frame, str(direction), (75,100), font, 1, (255, 255, 255), 2, cv.LINE_AA)
        cv.putText(frame, str(round(maxLeft)) + " MaxL", (450,100), font, 1, (255, 255, 255), 2, cv.LINE_AA)
        cv.putText(frame, str(round(maxRight)) + " MaxR", (450,150), font, 1, (255, 255, 255), 2, cv.LINE_AA)
